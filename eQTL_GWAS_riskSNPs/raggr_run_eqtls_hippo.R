...
# save(genePCs, exonPCs, jxnPCs, txPCs, 
	# file="eqtl_tables/rdas/pcs_4features_hippo.rda")
load("eqtl_tables/rdas/pcs_4features_hippo.rda")
...
save(meGene, meExon, meJxn, meTx,
	file="eqtl_tables/matrixEqtl_output_hippo_raggr_4features.rda")
...
allEqtl$gencodeTx = CharacterList(c(as.list(rowRanges(rse_gene)$gencodeTx[match(geneEqtl$gene, 
	...
	as.list(txEqtl$gene)))
save(allEqtl, file="eqtl_tables/mergedEqtl_output_hippo_raggr_4features.rda",compress=TRUE)
