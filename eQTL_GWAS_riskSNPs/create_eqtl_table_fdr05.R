...
sigEqtlHippo_sub = allEqtl[allEqtl$FDR < 0.05,]
load("eqtl_tables/mergedEqtl_output_dlpfc_raggr_4features.rda", verbose=TRUE)
sigEqtlDlpfc_sub = allEqtl[allEqtl$FDR < 0.05,]
...
write.csv(hippo3, "raggr_179snps_hippo_eqtls_fdr05.csv")
...
write.csv(dlp3, "raggr_179snps_dlp_eqtls_fdr05.csv")
