...
#$ -N step6-txQuant-HIPPO_riboZero_degradation.hg38
#$ -pe local 1
#$ -o ./logs/txQuant-HIPPO_riboZero_degradation.$TASK_ID.txt
#$ -e ./logs/txQuant-HIPPO_riboZero_degradation.$TASK_ID.txt
#$ -t 1-12
#$ -tc 15
