...
pd = pd[pd$Dataset == "Hippo_RiboZero",]

## read back in
## forward
bedForward = import("bed/HIPPO_RiboZero_ERs_cut5_Forward.bed")
...
## reverse
bedReverse = import("bed/HIPPO_RiboZero_ERs_cut5_Reverse.bed")
...
regionMat = rbind(erCovForward, erCovReverse)/100 # read length
...
## gene annotation
geneMap = read.delim("/dcl01/lieber/ajaffe/lab/brainseq_phase2/degradation/Hippo_RiboZero/Counts/gene/HIPPO_Br5941_D05_ribo_Gencode.v25.hg38_Genes.counts",
...
save(pd, regions, regionMat, file = "expressedRegions_HIPPO_RiboZero_degradation_cut5_hg38_n20.rda")