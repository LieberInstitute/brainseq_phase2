...
#$ -N step4-featCounts-DLPFC_polyA_degradation.hg38
#$ -pe local 8
#$ -o ./logs/featCounts-DLPFC_polyA_degradation.$TASK_ID.txt
#$ -e ./logs/featCounts-DLPFC_polyA_degradation.$TASK_ID.txt
#$ -t 1-20
#$ -tc 10
...
# Directories
mkdir -p /dcl01/lieber/ajaffe/lab/brainseq_phase2/degradation/DLPFC_polyA/Counts/gene
mkdir -p /dcl01/lieber/ajaffe/lab/brainseq_phase2/degradation/DLPFC_polyA/Counts/exon
mkdir -p /dcl01/lieber/ajaffe/lab/brainseq_phase2/degradation/DLPFC_polyA/Counts/junction/tmpdir
...
# junctions	
OUTJXN=/dcl01/lieber/ajaffe/lab/brainseq_phase2/degradation/DLPFC_polyA/Counts/junction/${ID}_junctions_primaryOnly_regtools.bed
OUTCOUNT=/dcl01/lieber/ajaffe/lab/brainseq_phase2/degradation/DLPFC_polyA/Counts/junction/${ID}_junctions_primaryOnly_regtools.count
TMPDIR=/dcl01/lieber/ajaffe/lab/brainseq_phase2/degradation/DLPFC_polyA/Counts/junction/tmpdir
