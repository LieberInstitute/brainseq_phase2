...
## load genomic state
load('/dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/gs/gs_gencode_v25.Rdata')
gs = gs_gencode_v25$fullGenome
ensemblAnno = annotateRegions(regions,gs,ignore.strand=FALSE,minoverlap=1)
...
rownames(geneMap) = geneCounts$Geneid
