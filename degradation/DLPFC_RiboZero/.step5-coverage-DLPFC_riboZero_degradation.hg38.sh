...
#$ -N step5-coverage-DLPFC_riboZero_degradation.hg38
#$ -o ./logs/coverage-DLPFC_riboZero_degradation.$TASK_ID.txt
#$ -e ./logs/coverage-DLPFC_riboZero_degradation.$TASK_ID.txt
#$ -t 1-20
#$ -tc 40
#$ -hold_jid pipeline_setup,step3-hisat2-DLPFC_riboZero_degradation.hg38,step3b-infer-strandness-DLPFC_riboZero_degradation.hg38
#$ -m a
echo "**** Job starts ****"
date
...
python ~/.local/bin/bam2wig.py -s /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/hg38.chrom.sizes.gencode -i /dcl01/lieber/ajaffe/lab/brainseq_phase2/degradation/DLPFC_RiboZero/HISAT2_out/${ID}_accepted_hits.sorted.bam -t 4000000000 -o /dcl01/lieber/ajaffe/lab/brainseq_phase2/degradation/DLPFC_RiboZero/Coverage/${ID} -d "${STRANDRULE}"

## Remove temp files
rm /dcl01/lieber/ajaffe/lab/brainseq_phase2/degradation/DLPFC_RiboZero/Coverage/${ID}*.wig
