...
#$ -N step8-callVariants-gtex.dlpfc
...
mkdir -p /dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/Genotypes/
...
SNPTMP=/dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/Genotypes/${ID}_tmp.vcf
SNPOUTGZ=/dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/Genotypes/${ID}.vcf.gz
