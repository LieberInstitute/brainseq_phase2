...
#$ -N step3-hisat2-gtex.dlpfc
#$ -pe local 8
#$ -o ./logs/hisat2-gtex.$TASK_ID.txt
#$ -e ./logs/hisat2-gtex.$TASK_ID.txt
#$ -t 1-108
#$ -tc 15
#$ -hold_jid pipeline_setup,step2-trim-gtex.dlpfc
#$ -m a
echo "**** Job starts ****"
date
...
# Directories
mkdir -p /dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/HISAT2_out/align_summaries
mkdir -p /dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/HISAT2_out/infer_strandness

if [ FALSE == "TRUE" ]
then
    mkdir -p /dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/HISAT2_out/unaligned
fi
...
if [ -f /dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/trimmed_fq/${ID}_trimmed_forward_paired.fastq ] ; then
	## Trimmed, paired-end
	...
	/dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Software/hisat2-2.0.4/hisat2 -p 8 	-x /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/GENCODE/GRCh38_hg38/hisat2_GRCh38primary -1 $FP -2 $RP -U ${FU},${RU} 	-S /dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/HISAT2_out/${ID}_hisat_out.sam  --phred33      	2>/dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/HISAT2_out/align_summaries/${ID}_summary.txt
	
elif  [ -f /dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/trimmed_fq/${ID}_trimmed.fastq ] ; then
	## Trimmed, single-end
	echo "HISAT2 alignment run on trimmed single-end reads"
	/dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Software/hisat2-2.0.4/hisat2 -p 8 	-x /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/GENCODE/GRCh38_hg38/hisat2_GRCh38primary -U /dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/trimmed_fq/${ID}_trimmed.fastq 	-S /dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/HISAT2_out/${ID}_hisat_out.sam  --phred33 	2>/dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/HISAT2_out/align_summaries/${ID}_summary.txt
...
###sam to bam
SAM=/dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/HISAT2_out/${ID}_hisat_out.sam
ORIGINALBAM=/dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/HISAT2_out/${ID}_accepted_hits.bam
SORTEDBAM=/dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/HISAT2_out/${ID}_accepted_hits.sorted
...
~/.local/bin/infer_experiment.py -i ${SORTEDBAM}.bam -r /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/RSeQC/hg38.bed 1> /dcl01/lieber/ajaffe/lab/brainseq_phase2/gtex_dlpfc/HISAT2_out/infer_strandness/${ID}.txt 2>&1
