...
keepInd = which(colData(rse_gene)$Age > 13  & colData(rse_gene)$Race == 'CAUC')
...
save(genePCs,
	file="rdas/pcs_gene_combined_regions_filtered_over13.rda")
...
rownames(covsGene)[nrow(covsGene)] = colnames(mod)[modReg]
...
save(geneEqtl, file="eqtl_tables/mergedEqtl_output_interaction_gene.rda",compress=TRUE)
