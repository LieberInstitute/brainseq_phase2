...
if(TRUE){
    opt <- list('organism' = 'hg38',
        'maindir' = '/dcl01/lieber/ajaffe/lab/brainseq_phase2/preprocessed_data/Hippo_RiboZero',
        'experiment' = 'HIPPO_RiboZero_BrainSeq_Phase2',
        'prefix' = 'LIBD',
        'paired' = TRUE,
		'stranded' = 'reverse',
        'ercc' = TRUE,
...
jIndex = which(rowSums(as.data.frame(jCountsLogical)) >= 5) 
