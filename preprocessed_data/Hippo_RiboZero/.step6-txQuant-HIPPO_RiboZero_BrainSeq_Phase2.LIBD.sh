...
#$ -N step6-txQuant-HIPPO_RiboZero_BrainSeq_Phase2.LIBD
#$ -pe local 2
#$ -o ./logs/txQuant-HIPPO_RiboZero_BrainSeq_Phase2.$TASK_ID.txt
#$ -e ./logs/txQuant-HIPPO_RiboZero_BrainSeq_Phase2.$TASK_ID.txt
#$ -t 1-0
#$ -tc 15
#$ -hold_jid pipeline_setup,step4-featCounts-HIPPO_RiboZero_BrainSeq_Phase2.LIBD
#$ -m a
echo "**** Job starts ****"
date
