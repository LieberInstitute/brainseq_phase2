#!/bin/bash
#$ -cwd
#$ -l bluejay,mem_free=15G,h_vmem=20G,h_fsize=100G
#$ -N step5-coverage-HIPPO_RiboZero_BrainSeq_Phase2.LIBD
#$ -o ./logs/coverage-HIPPO_RiboZero_BrainSeq_Phase2.$TASK_ID.txt
#$ -e ./logs/coverage-HIPPO_RiboZero_BrainSeq_Phase2.$TASK_ID.txt
#$ -t 2
#$ -tc 40
#$ -hold_jid pipeline_setup,step3-hisat2-HIPPO_RiboZero_BrainSeq_Phase2.LIBD,step3b-infer-strandness-HIPPO_RiboZero_BrainSeq_Phase2.LIBD
#$ -m a
echo "**** Job starts ****"
date
