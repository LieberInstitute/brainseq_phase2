...
#$ -N step4-featCounts-DLPFC_RiboZero_BrainSeq_Phase2.LIBD
#$ -pe local 8
#$ -o ./logs/featCounts-DLPFC_RiboZero_BrainSeq_Phase2.$TASK_ID.txt
#$ -e ./logs/featCounts-DLPFC_RiboZero_BrainSeq_Phase2.$TASK_ID.txt
#$ -t 1-0
#$ -tc 10
...
# Directories
mkdir -p /dcl01/lieber/ajaffe/lab/brainseq_phase2/preprocessed_data/DLPFC_RiboZero/Counts/gene
mkdir -p /dcl01/lieber/ajaffe/lab/brainseq_phase2/preprocessed_data/DLPFC_RiboZero/Counts/exon
mkdir -p /dcl01/lieber/ajaffe/lab/brainseq_phase2/preprocessed_data/DLPFC_RiboZero/Counts/junction/tmpdir
