...
#$ -N step1-fastqc-DLPFC_RiboZero_BrainSeq_Phase2.LIBD
#$ -o ./logs/fastqc-DLPFC_RiboZero_BrainSeq_Phase2.$TASK_ID.txt
#$ -e ./logs/fastqc-DLPFC_RiboZero_BrainSeq_Phase2.$TASK_ID.txt
#$ -t 1-0
#$ -tc 100
...
if [ FALSE == "TRUE" ]
then 
    /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Software/FastQC_v0.11.5/fastqc ${FILE1} ${FILE2} --outdir=/dcl01/lieber/ajaffe/lab/brainseq_phase2/preprocessed_data/DLPFC_RiboZero/FastQC/Untrimmed/${ID} --extract
else
    /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Software/FastQC_v0.11.5/fastqc ${FILE1} --outdir=/dcl01/lieber/ajaffe/lab/brainseq_phase2/preprocessed_data/DLPFC_RiboZero/FastQC/Untrimmed/${ID} --extract
fi
