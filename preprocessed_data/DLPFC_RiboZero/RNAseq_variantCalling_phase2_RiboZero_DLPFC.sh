...
#$ -N varCall-brainseq.DLPFC_RiboZero
#$ -pe local 1
...
SNPTMP=/dcl01/lieber/ajaffe/lab/brainseq_phase2/preprocessed_data/DLPFC_RiboZero/Genotypes/${ID}_calledVariants.tmp
SNPOUT=/dcl01/lieber/ajaffe/lab/brainseq_phase2/preprocessed_data/DLPFC_RiboZero/Genotypes/${ID}_calledVariants.txt
