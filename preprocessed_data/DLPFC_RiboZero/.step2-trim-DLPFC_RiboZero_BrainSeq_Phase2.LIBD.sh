...
#$ -N step2-trim-DLPFC_RiboZero_BrainSeq_Phase2.LIBD
#$ -pe local 8
#$ -o ./logs/trim-DLPFC_RiboZero_BrainSeq_Phase2.$TASK_ID.txt
#$ -e ./logs/trim-DLPFC_RiboZero_BrainSeq_Phase2.$TASK_ID.txt
#$ -t 1-0
#$ -tc 5
#$ -hold_jid pipeline_setup,step1-fastqc-DLPFC_RiboZero_BrainSeq_Phase2.LIBD
#$ -m a
echo "**** Job starts ****"
date
...
if [ FALSE == "TRUE" ] ; then 
	REPORT1=/dcl01/lieber/ajaffe/lab/brainseq_phase2/preprocessed_data/DLPFC_RiboZero/FastQC/Untrimmed/${ID}/${FILEBASE1}_fastqc/summary.txt
	REPORT2=/dcl01/lieber/ajaffe/lab/brainseq_phase2/preprocessed_data/DLPFC_RiboZero/FastQC/Untrimmed/${ID}/${FILEBASE2}_fastqc/summary.txt
	...
	if [[ $RESULT1 == "FAIL" ]] ; then
		...
		mkdir -p /dcl01/lieber/ajaffe/lab/brainseq_phase2/preprocessed_data/DLPFC_RiboZero/trimmed_fq
		OUT=/dcl01/lieber/ajaffe/lab/brainseq_phase2/preprocessed_data/DLPFC_RiboZero/trimmed_fq/${ID}_trimmed.fastq
