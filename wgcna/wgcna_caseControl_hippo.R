...
keepIndex = which(rse_gene$Age > 17 & 		# hippo only has CAUC and AA	# 333
...
# save(sftQsva, file="rdas/wgcna_soft_threshold_Hippo_gene.rda")
load("rdas/wgcna_soft_threshold_Hippo_gene.rda")
...
# netQsva = blockwiseModules(t(geneExprsQsva), power = sftQsva$powerEstimate,
	...
	# saveTOMFileBase = "rdas/Hippo_gene_qSVA")
# save(netQsva, geneMap, file = "rdas/Hippo_gene_wgcnaModules.rda")

####

load("rdas/Hippo_gene_wgcnaModules.rda", verbose=TRUE)

table(netQsva$colors)  ## 39 clusters. top 10:
